...
export class ChunckVertexData {
        ...
        public static SplitVertexDataTriangles(data: VertexData): VertexData {
            if (!data.positions || !data.indices || !data.normals) {
                return data;
            }
        ...
        public static RotateX(baseData: VertexData): VertexData {
            if (!baseData.positions || !baseData.indices || !baseData.normals) {
                return baseData;
            }
        ...
        public static Add(baseData1: VertexData, baseData2: VertexData): VertexData {
            if (!baseData1.positions || !baseData1.indices || !baseData1.normals || !baseData2.positions || !baseData2.indices || !baseData2.normals) {
                return baseData1;
            }
