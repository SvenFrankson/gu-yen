...
BlockTypeColors[BlockType.Wood] = new Color3(0.600, 0.302, 0.020);
BlockTypeColors[BlockType.Leaf] = Color3.FromHexString("#66631C");
BlockTypeColors[BlockType.Laterite] = new Color3(0.839, 0.431, 0.020);
...
BlockTypeColors[BlockType.Rust] = new Color3(0.839, 0.431, 0.020);
