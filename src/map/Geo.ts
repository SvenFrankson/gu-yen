...
export class GeoConverter {
    ...
    public halfAngularHeight = Math.atan2(16384, this.radius) / Math.PI * 180;
    public halfAngularWidth = Math.atan2(16384, this.radius * Math.cos(this.latZero * Math.PI / 180)) / Math.PI * 180;
    ...
    public latLongToVector3(latitude: number, longitude: number): Vector3 {
        let x = (longitude - this.longZero) / this.halfAngularWidth * 16384;
        let z = (latitude - this.latZero) / this.halfAngularHeight * 16384;
