export class DebugDisplayFrameValue extends HTMLElement {
    ...
    private _minElement: HTMLSpanElement | null = null;
    private _maxElement: HTMLSpanElement | null = null;
    private _labelElement: HTMLSpanElement | null = null;
    private _valuesElement: SVGPathElement | null = null;
    ...
    public attributeChangedCallback(name: string, oldValue: string, newValue: string) {
        if (this._initialized) {
            ...
            if (name === "label" && this._labelElement) {
